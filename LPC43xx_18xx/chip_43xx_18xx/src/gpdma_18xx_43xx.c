...
static const uint8_t GPDMA_LUTPerBurst[] = {
	...
	GPDMA_BSIZE_32,	/* I2S channel 0      */
	GPDMA_BSIZE_32,	/* I2S channel 0      */
	GPDMA_BSIZE_8,	/* ADCHS write        */
	GPDMA_BSIZE_8	/* ADCHS read         */
};
...
static const uint8_t GPDMA_LUTPerWid[] = {
	...
	GPDMA_WIDTH_WORD,	/* I2S channel 0      */
	GPDMA_WIDTH_WORD,	/* I2S channel 0      */
	GPDMA_WIDTH_WORD,	/* ADCHS write        */
	GPDMA_WIDTH_WORD	/* ADCHS read         */
};
...
volatile static const void *GPDMA_LUTPerAddr[] = {
	...
	(&LPC_ADCHS->DESCRIPTOR),		/* ADCHS write        */
	(&LPC_ADCHS->FIFO_OUTPUT)		/* ADCHS read         */
};
