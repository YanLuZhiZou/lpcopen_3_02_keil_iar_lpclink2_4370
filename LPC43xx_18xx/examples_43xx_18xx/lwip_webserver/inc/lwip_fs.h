...
/** @defgroup EXAMPLE_LWIP_WEBSERVER_18XX43XX_FS Filesystem Glue logic for reading http files
 * @ingroup EXAMPLE_LWIP_WEBSERVER_18XX43XX
...
/**
 * @brief	Initialize the filesystem and device on it
