...
/* OUTPUT registers */
LPC_SCT->OUT[3].SET = 0x00000210;        /* LED1 */
LPC_SCT->OUT[3].CLR = 0x00000844;
LPC_SCT->OUT[2].SET = 0x00000024;        /* LED2 */
LPC_SCT->OUT[2].CLR = 0x00000818;
LPC_SCT->OUT[4].SET = 0x00000108;        /* LED3 */
LPC_SCT->OUT[4].CLR = 0x000008A0;
LPC_SCT->OUT[5].SET = 0x00000480;        /* LED4 */
LPC_SCT->OUT[5].CLR = 0x00000902;
...
LPC_SCT->OUTPUT = (LPC_SCT->OUTPUT & ~0x0000003C) | 0x00000000;

/* Conflict resolution register */

/* EVENT registers */
LPC_SCT->EVENT[1].CTRL = 0x00007180;     /* L: --> state L_ENTRY */
LPC_SCT->EVENT[1].STATE = 0x00000008;
LPC_SCT->EVENT[11].CTRL = 0x00006C00;     /* L: --> state L_ENTRY */
LPC_SCT->EVENT[11].STATE = 0xFFFFFFFF;
LPC_SCT->EVENT[2].CTRL = 0x00017180;     /* L: --> state LED2on */
LPC_SCT->EVENT[2].STATE = 0x00000002;
LPC_SCT->EVENT[3].CTRL = 0x00027180;     /* L: --> state LED3on */
LPC_SCT->EVENT[3].STATE = 0x00000004;
LPC_SCT->EVENT[0].CTRL = 0x00001000;     /* L: */
LPC_SCT->EVENT[0].STATE = 0xFFFFFFFF;
LPC_SCT->EVENT[4].CTRL = 0x0000FD80;     /* L: --> state LED1on */
LPC_SCT->EVENT[4].STATE = 0x00000004;
LPC_SCT->EVENT[5].CTRL = 0x00017D80;     /* L: --> state LED2on */
LPC_SCT->EVENT[5].STATE = 0x00000010;
LPC_SCT->EVENT[6].CTRL = 0x00007D80;     /* L: --> state L_ENTRY */
LPC_SCT->EVENT[6].STATE = 0x00000002;
LPC_SCT->EVENT[7].CTRL = 0x0001F180;     /* L: --> state LED4on */
LPC_SCT->EVENT[7].STATE = 0x00000010;
LPC_SCT->EVENT[8].CTRL = 0x00027D80;     /* L: --> state LED3on */
LPC_SCT->EVENT[8].STATE = 0x00000008;
LPC_SCT->EVENT[9].CTRL = 0x0000F180;     /* L: --> state LED1on */
LPC_SCT->EVENT[9].STATE = 0x00000001;
LPC_SCT->EVENT[10].CTRL = 0x0001FD80;     /* L: --> state LED4on */
