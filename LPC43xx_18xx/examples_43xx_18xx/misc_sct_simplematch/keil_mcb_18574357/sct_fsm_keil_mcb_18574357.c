...
LPC_SCT->OUT[14].SET = 0x00000049;        /* CTOUT0 */
LPC_SCT->OUT[14].CLR = 0x00000041;
LPC_SCT->OUT[10].SET = 0x00000029;        /* CTOUT1 */
LPC_SCT->OUT[10].CLR = 0x00000021;
LPC_SCT->OUT[13].SET = 0x0000000B;        /* CTOUT2 */
LPC_SCT->OUT[13].CLR = 0x00000003;
LPC_SCT->OUT[11].SET = 0x0000001D;        /* CTOUT3 */
LPC_SCT->OUT[11].CLR = 0x00000011;
...
LPC_SCT->OUTPUT = (LPC_SCT->OUTPUT & ~0x00000040) | 0x00006C00;

/* Conflict resolution register */
LPC_SCT->RES = (LPC_SCT->RES & ~0x3CF00000) | 0x3CF00000;
